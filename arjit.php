...
<html lang="en">
  <head>
    ...
    <title>Online Music Store Website</title>
    <style>
    ...
    <header>
      <div class="menu_side">
        ...
        <div class="playlist">
          ...
          <h4>
            <span></span><i class="bi bi-music-note-beamed"></i>Recommanded
          </h4>
        </div>
        <div class="menu_song">
          <li class="songItem">
      ...
      <div class="song_side">
        <nav>
          ...
          <div class="user">
            <img src="img/Anmol logo.png" alt="" />
          </div>
        </nav>
        <div class="content">
          <h1>Arijit Singh</h1>
          <p>
            You were the shadow to my light did yo feel us Another start you
            fade <br />
            Away afraid our aim is not out of sight Wanna see Alive
          </p>
          <div class="buttons">
            <button>PLAY</button>
